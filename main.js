...
// let piggeywords = ""
// function updatePiggyWords() {
//   let piggeywords = document.getElementById("piggywords").value

//   console.log(piggeywords)
// }
const pigLatin = () => {  
let bestpiggy= document.getElementById("piggywords").value;
let groupOfWords= bestpiggy.split(" ")
console.log(typeof bestpiggy)
...
document.getElementById("translatedWords").innerHTML = (newlistwords)
